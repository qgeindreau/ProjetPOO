...
class CommunauteIGraph:
    def __init__(self,doc_citations,path_Article=os.getcwd()):
        Aut = gga.GraphAut(path=path_Article,corrected=False,Traduit=False)#Variable enregistrant toutes les infos
    ...
    def influenceArt(self,art,profondeur):
        mat_influence=nw.to_pandas_adjacency(nw.ego_graph(self.GraphCit, art, radius=profondeur))#On prends la matrice d'adjacence du graphe réduit
    ...
    def influencedArt(self,art,profondeur):#Comme pour InfluenceArt mais en prenant de graphe avec les arc retournés
    ...
    def influenced(self,name,profondeur):#Comme pour influence mais avec influencedArt
    ...
    def communaute(self,name,profondeur):#On définie la communauté comme l'intersection de ceux qui influence et ceux qui sont influencé
